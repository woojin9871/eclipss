...
public class RandomEx {
	...
	public static void main(String[] args) {
		...
		// nextBoolean() : boolean 램덤수(난수) 를 반환하는 메소드
		// nextDouble : double 램덤수(난수) 를 반환하는 메소드
		...
		// 4byte 범위 : (-21억xxx ~ 21억xxxx) 사이의 난수를 반환
		int fourByteRandom = random.nextInt();
		System.out.println("4바이트 램덤 정수 : " + fourByteRandom);
		...
		System.out.println("실수 램덤 수 : " + randomDouble);
	}
}
