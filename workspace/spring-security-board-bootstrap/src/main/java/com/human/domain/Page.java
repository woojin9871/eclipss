...
public class Page {
	...
	private static final int PAGE_NO = 1; 			// 현재 페이지 번호
	private static final int ROWS_PER_PAGE = 10;	// 페이지당 행의 수
	private static final int PAGE_COUNT = 10;		// 최대 노출 페이지 수
	
	private int pageNo;		 // 현재 페이지 번호
	private int rowsPerPage; // 페이지당 행의 수
	private int pageCount;	 // 노출 페이지 수
	...
	private int prev;	 	 // 이전 게시글 목록
	private int next;		 // 다음 게시글 목록
	...
	public void paging() {
		...
		this.endPage = ( ((pageNo - 1) / pageCount) + 1 ) * pageCount + 1;
