...
public class BoardController {
	...
	// 파일목록 리스트 가져오기		GET /board/file/list
	// 썸네일 목록 리스트 가져오기	GET /board/img/list
...
//		int result = service.delete(boardNo);
	...
	public String boardFileList(Model model, int boardNo, Files file) throws Exception {
	 ...
	 * @throws Exception 
	 */
	@GetMapping("/board/img/list")
	public String boardImgList(Model model, int boardNo, Files file) throws Exception {
