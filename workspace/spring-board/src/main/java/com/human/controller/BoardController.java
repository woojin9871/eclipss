...
public class BoardController {
	...
	public String list(Model model) throws Exception {
		List<Bo_notice> boardList = service.list();
	...
	public String read(Model model, int boardNo) throws Exception {
		...
		Bo_notice board = service.read(boardNo);
	...
	public String updatePost(Bo_notice bo_notice) throws Exception {
		// 요청 파라미터명과 일치하는 변수명을 가지고 있는 객체를 사용하여 여러 파라미터를 가져올 수 있다.
		int boardNo = bo_notice.getBoardNo();
		String title = bo_notice.getTitle();
		String writer = bo_notice.getWriter();
		String content = bo_notice.getContent();
		
		int result = service.update(bo_notice);
